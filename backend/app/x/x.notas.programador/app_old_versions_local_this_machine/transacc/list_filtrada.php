...
$sql = "SELECT a.*, CONCAT(a.origen_codpais,a.destino_codpais,LPAD(a.id, 4, '0')) AS refcompleta, LPAD(a.id, 4, '0') AS referencia, u.nombre from transacciones a INNER JOIN user u USING (login) ".$where." ORDER BY a.date_created, a.login desc";

...
$sql = "INSERT INTO transacciones (login_user, origen_codpais, destino_codpais, origen_monto, destino_monto, tasa_dolar_origen, tasa_dolar_destino, fechahora_origen, fechahora_destino)
        VALUES (" // --('appcode', 'PAR', 'VEN', '6000', '13000', '6000', '13000', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP)";
  ."'". $data['user']['login'] ."',"
  ."'". $data['cod_pais1'] ."',"
  ."'". $data['cod_pais2'] ."',"
  .     $data['monto1'] .","
